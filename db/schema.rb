...
ActiveRecord::Schema[7.1].define(version: 26) do
  ...
  create_table "event_art_works", force: :cascade do |t|
    t.bigint "event_id"
    t.bigint "art_work_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["art_work_id"], name: "index_event_art_works_on_art_work_id"
    t.index ["event_id"], name: "index_event_art_works_on_event_id"
  end
  ...
  create_table "location_artists", force: :cascade do |t|
    t.bigint "location_id"
    t.bigint "artist_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["artist_id"], name: "index_location_artists_on_artist_id"
    t.index ["location_id"], name: "index_location_artists_on_location_id"
  end
